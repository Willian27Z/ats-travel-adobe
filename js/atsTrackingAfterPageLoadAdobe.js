$(function() {
    ...
    nav.click(function(e) {
        if (this.text == 'Sign-out') {
            ...
            if (window._satellite && window._satellite.track) {
                window._satellite.track("signOut");
            }
        ...
        cnx.click(function(e) {
            ...
            if (!!connected_user_id) {
                ...
                if (mdp.val() == connected_user_id.password) {
                     ...
                     */
                    if (window._satellite && window._satellite.track) {
                        window._satellite.track("signIn", {
    ...
    if (/index\.html/.test(window.location.pathname)) {
         ...
         */
        window.digitalData.promotions = promotions;
        ...
        $(".carousel-inner a").on('click', function(e) {
            ...
            for (var v = 0; v < promotions.length; v++) {
                if (promotions[v].creative_name.match(destination[1]) !== null) {
                     ...
                     */
                    if (window._satellite && window._satellite.track) {
                        window._satellite.track("promotionClick", promotions[v]);
                    }
        ...
        $("#viewDestination a").on('click', function(e) {
             ...
             */
            if (window._satellite && window._satellite.track) {
                window._satellite.track("CTAclick", {
                    name: "View Destinations - home"
                });
            }
    ...
    if (/destinations\.html/.test(window.location.pathname)) {
        ...
        var location = window.location.search.replace('?search=', ''),
            list = "all",
            cat;
         ...
         */
        digitalData.pageCategory = "product list";
                ...
                element.addEventListener('click', function(event) {
                    for (var v = 0; v < products.length; v++) {
                        if (event.target.getAttribute("href").match(products[v].item_name.toLocaleLowerCase()) !== null) {
                             ...
                             */
                            if (window._satellite && window._satellite.track) {
                                window._satellite.track("productClick", products[v]);
                            }
    ...
    if (/basket\.html/.test(window.location.pathname)) {
        ...
        if (JSON.parse(getCookie('55Basket')) || cart55.length < 1) {
			...
			// if (window._satellite && window._satellite.track) {
            //     window._satellite.track("viewCart", {
            //         totalPrice: totalPrice,
			// 		products: products
            //     });
            // }
            window.digitalData.pageCategory = "cart";
            ...
            $('.remove').on('click', function(e) {
                 ...
                 */
				if (window._satellite && window._satellite.track) {
					window._satellite.track("removeFromCart", productRemoved);
				}
        ...
        $('#confirmReservation').on('click', function(e) {
            if ($('#paymentMethod').css('display') === 'block') {
                ...
                if (name != '' && adress != '' && zip != '' && city != '') {
					...
					// if (window._satellite && window._satellite.track) {
					// 	window._satellite.track("checkoutBegin");
					// }
                     ...
                     */
					if (window._satellite && window._satellite.track) {
						window._satellite.track("checkoutPaymentInitiated", products);
					}
                    ...
                    document.getElementById('submitButton').addEventListener('click', function() {
                         ...
                         * use products JS variable to get the basket products details
                         */
						//console.log("payment checkout option");
						if (window._satellite && window._satellite.track) {
							window._satellite.track("checkoutPaymentSent", products);
						}
    ...
    $('#newsletter-form form').on('submit', function(e) {
        ...
        if (!!patt.test(input.val())) {
             ...
             */
			if (window._satellite && window._satellite.track) {
				window._satellite.track("newsletterSubscription", {email: input.val()});
			}
